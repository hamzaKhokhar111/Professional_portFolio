        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i><b className="purple">MERN stack</b></i>, with strong expertise in both{" "}
              <i><b className="purple">frontend</b></i> and{" "}
              <i><b className="purple">backend development</b></i>. 
              <br />
              <br />
              I have a solid foundation in{" "}
              <i><b className="purple">Data Structures and Algorithms</b></i> and a passion for building{" "}
              <i><b className="purple">scalable, high-performance web applications</b></i>.
              <br />
              <br />
              ...
              <i><b className="purple">React.js, Next.js, Node.js</b></i> and{" "}
              <i><b className="purple">MongoDB</b></i>.
            </p>
          </Col>
